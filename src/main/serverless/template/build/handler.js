...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CandidateServiceImpl = (function () {
	    ...
	    CandidateServiceImpl.prototype.update = function (data) {
	        ...
	        obj.from.path('./datafile/OutWit guess export - IT_Services_in_Bangalore_Karnataka_India.csv').to.array(function (data1) {
	            for (var index = 0; index < data1.length; index++) {
	                for (var index1 = 0; index1 < data1[index].length; index1++) {
	                    console.log("data1[index]= " + data1[index]);
	                    // var a1=data1[index];
	                    var a = ((data1[index])[index1]);
	                    //console.log("a= " +a);
	                    // console.log("data1 length = "+data1.length);
	                    // console.log("name=  "+a.split(";")[0]);
	                    ...
	                    //console.log("phone number=  "+a.split(";")[7].substring(0, 10));
	                    var letterNumber = /^[0-9]+$/;
	                    console.log("email id :" + a.split(";")[1]);
	                    //console.log("email id :" +a2.split(";")[1]);
	                    console.log("--------------------------------------------------");
	                    console.log("duplicate Email -ids");
	                    var params = {
	                        TableName: "candidate",
	                        Key: {
	        ...
	        console.log('after the file read method');
	        return rxjs_1.Observable.create(function (observer) {
	        });
	    };
